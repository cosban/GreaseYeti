...
var load_gif =
  'data:image/gif;base64,R0lGODlhEAAQAPIAAP///2Zm/9ra/o2N/mZm/6Cg/rOz/r29/iH/C' +
  ...
  'AAAAQABAAAAMyCLrc/jDKSatlQtScKdceCAjDII7HcQ4EMTCpyrCuUBjCYRgHVtqlAiB1YhiCnl' +
      ...
      function () {
        $(this)
          ...
          .val(function (i, v) {
            ...
            var stamp = 'Just now';
            if (now - d > 5 * 60000)
              stamp = Math.floor((now - d) / 60000) +
              'm ago';
            if (now - d > 3600000)
              stamp = Math.floor((now - d) / 3600000) +
              'h ago';
            if (now - d > 86400000)
              stamp = Math.floor((now - d) / 86400000) +
              ' days ago';
  ...
  $('body')
    .before(
      `  <style type = "text/css">
														...
														body.chat_mode form.quickpost textarea {
														height : 100px;
													}
									`
    );
